	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatahealthsunpartdeob&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdatahealthsunpartdeob</h3></div>
  <div class="panel-body">
	...
	<input name="documentDate" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo date('Y-m-d');?>" required/>
	</div>
	...
	<input id="languageType" name="languageType" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="claimId" name="claimId" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
