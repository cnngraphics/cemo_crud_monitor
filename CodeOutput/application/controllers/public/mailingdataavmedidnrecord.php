	...
	*/
	...
	include(APP_FOLDER.'/views/public/mailingdataavmedidnrecord/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mailingdataavmedidnrecord_model->SelectAll();
	include(APP_FOLDER.'/views/public/mailingdataavmedidnrecord/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mailingdataavmedidnrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdataavmedidnrecord/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/public/mailingdataavmedidnrecord/Add.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdataavmedidnrecord&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/public/mailingdataavmedidnrecord/Update.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdataavmedidnrecord&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mailingdataavmedidnrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdataavmedidnrecord/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mailingdataavmedidnrecord_model->TruncateTable(''.H_CLIENT.'&view=mailingdataavmedidnrecord&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/public/mailingdataavmedidnrecord/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mailingdataavmedidnrecord_model->Delete(get('id'),''.H_CLIENT.'&view=mailingdataavmedidnrecord&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_CLIENT.'&view=mailingdataavmedidnrecord&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
