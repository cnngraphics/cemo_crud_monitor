	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatadevotedidcards&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdatadevotedidcards</h3></div>
  <div class="panel-body">
	...
	<input name="processDate" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo date('Y-m-d');?>" required/>
	</div>
	...
	<input id="address3" name="address3" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="pbpName">PbpName</label>
	<div class="input-group-addon left">PbpName</div>
	<input id="pbpName" name="pbpName" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="pcpName" name="pcpName" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="language">Language</label>
	<div class="input-group-addon left">Language</div>
	<input id="language" name="language" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="recordId" name="recordId" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input name="completeDate" class="datepicker form-control styler" type="text" maxlength="20" value="<?php echo date('Y-m-d');?>" required/>
	</div>
	...
	<input id="trackingNumber" name="trackingNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="shipError">ShipError</label>
	<div class="input-group-addon left">ShipError</div>
	<input id="shipError" name="shipError" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
