	...
	*/
	...
	include(APP_FOLDER.'/views/public/jobinterfaceitem/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->jobinterfaceitem_model->SelectAll();
	include(APP_FOLDER.'/views/public/jobinterfaceitem/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->jobinterfaceitem_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/jobinterfaceitem/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/public/jobinterfaceitem/Add.php');
	}
	...
	json_send(''.H_CLIENT.'&view=jobinterfaceitem&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/public/jobinterfaceitem/Update.php');
	}
	...
	json_send(''.H_CLIENT.'&view=jobinterfaceitem&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->jobinterfaceitem_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/jobinterfaceitem/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->jobinterfaceitem_model->TruncateTable(''.H_CLIENT.'&view=jobinterfaceitem&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/public/jobinterfaceitem/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->jobinterfaceitem_model->Delete(get('id'),''.H_CLIENT.'&view=jobinterfaceitem&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_CLIENT.'&view=jobinterfaceitem&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
