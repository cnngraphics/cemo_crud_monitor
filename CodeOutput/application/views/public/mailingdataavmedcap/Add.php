	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmedcap&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdataavmedcap</h3></div>
  <div class="panel-body">
	...
	<input id="checkNumber" name="checkNumber" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="checkDate">CheckDate</label>
	<div class="input-group-addon left">CheckDate</div>
	<input id="checkDate" name="checkDate" type="text" maxlength="10"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="checkAmount">CheckAmount</label>
	<div class="input-group-addon left">CheckAmount</div>
	<input id="checkAmount" name="checkAmount" type="text" maxlength="15"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="mailingDataAvmedCAPRecord_id" name="mailingDataAvmedCAPRecord_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
