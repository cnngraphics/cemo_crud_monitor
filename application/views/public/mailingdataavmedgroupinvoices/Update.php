	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmedgroupinvoices&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mailingdataavmedgroupinvoices&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdataavmedgroupinvoices&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdataavmedgroupinvoices&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mailingdataavmedgroupinvoices</h3></div>
  <div class="panel-body">
	...
	<input name="documentDate" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo $rows->documentDate;?>" required/>
	</div>
	...
	<input id="lastPage" name="lastPage" type="text" maxlength="11"  value="<?php echo $rows->lastPage;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="reprint">Reprint</label>
	<div class="input-group-addon left">Reprint</div>
	<input id="reprint" name="reprint" type="text" maxlength="11"  value="<?php echo $rows->reprint;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="avmedID">AvmedID</label>
	<div class="input-group-addon left">AvmedID</div>
	<input id="avmedID" name="avmedID" type="text" maxlength="255"  value="<?php echo $rows->avmedID;?>" class="form-control styler" required/>
	</div>
	...
	<div class="form-group">
    <label class="control-label sr-only" for="mailingDataRecord10_id">MailingDataRecord10 Id</label>
	<div class="input-group-addon left">MailingDataRecord10 Id</div>
	<input id="mailingDataRecord10_id" name="mailingDataRecord10_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataRecord10_id;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="mailingDataRecord20_id">MailingDataRecord20 Id</label>
	<div class="input-group-addon left">MailingDataRecord20 Id</div>
	<input id="mailingDataRecord20_id" name="mailingDataRecord20_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataRecord20_id;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="mailingDataRecord21_id">MailingDataRecord21 Id</label>
	<div class="input-group-addon left">MailingDataRecord21 Id</div>
	<input id="mailingDataRecord21_id" name="mailingDataRecord21_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataRecord21_id;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="mailingDataRecord30_id">MailingDataRecord30 Id</label>
	<div class="input-group-addon left">MailingDataRecord30 Id</div>
	<input id="mailingDataRecord30_id" name="mailingDataRecord30_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataRecord30_id;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="mailingDataRecord40_id">MailingDataRecord40 Id</label>
	<div class="input-group-addon left">MailingDataRecord40 Id</div>
	<input id="mailingDataRecord40_id" name="mailingDataRecord40_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataRecord40_id;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="mailingDataRecord50_id">MailingDataRecord50 Id</label>
	<div class="input-group-addon left">MailingDataRecord50 Id</div>
	<input id="mailingDataRecord50_id" name="mailingDataRecord50_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataRecord50_id;?>" class="form-control styler" required/>
	</div>
