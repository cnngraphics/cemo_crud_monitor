<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdatabadcockstatements</p>';
	$excel.='
	...
	<td>'.$rows->customerNumber.'</td>
  	</tr>
    <tr>
	<td>BeginningCycle</td>
	<td>'.$rows->beginningCycle.'</td>
  	</tr>
    <tr>
	<td>EndingCycle</td>
	<td>'.$rows->endingCycle.'</td>
  	</tr>
    <tr>
	<td>StoreNumber</td>
	<td>'.$rows->storeNumber.'</td>
  	</tr>
    <tr>
	<td>Cycle</td>
	<td>'.$rows->cycle.'</td>
   ...
   $excel.='</table>';
	...
	$filename1= 'mailingdatabadcockstatements_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdatabadcockstatements_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdatabadcockstatements_'.date('Y-m-d').'.pdf';
	if ($etype == 'word') 
    {
        MSWord($filename1);
        print $excel;
