	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmedcap&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mailingdataavmedcap&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdataavmedcap&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdataavmedcap&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mailingdataavmedcap</h3></div>
  <div class="panel-body">
	...
	<input id="checkNumber" name="checkNumber" type="text" maxlength="11"  value="<?php echo $rows->checkNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="checkDate">CheckDate</label>
	<div class="input-group-addon left">CheckDate</div>
	<input id="checkDate" name="checkDate" type="text" maxlength="10"  value="<?php echo $rows->checkDate;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="checkAmount">CheckAmount</label>
	<div class="input-group-addon left">CheckAmount</div>
	<input id="checkAmount" name="checkAmount" type="text" maxlength="15"  value="<?php echo $rows->checkAmount;?>" class="form-control styler" required/>
	</div>
	...
	<div class="form-group">
    <label class="control-label sr-only" for="mailingDataAvmedCAPRecord_id">MailingDataAvmedCAPRecord Id</label>
	<div class="input-group-addon left">MailingDataAvmedCAPRecord Id</div>
	<input id="mailingDataAvmedCAPRecord_id" name="mailingDataAvmedCAPRecord_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataAvmedCAPRecord_id;?>" class="form-control styler" required/>
	</div>
