	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatahealthsunidcards&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mailingdatahealthsunidcards&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatahealthsunidcards&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatahealthsunidcards&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mailingdatahealthsunidcards</h3></div>
  <div class="panel-body">
	...
	<div class="form-group">
    <label class="control-label sr-only" for="memberPBPID">MemberPBPID</label>
	<div class="input-group-addon left">MemberPBPID</div>
	<input id="memberPBPID" name="memberPBPID" type="text" maxlength="255"  value="<?php echo $rows->memberPBPID;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="createdDate">CreatedDate</label>
	<div class="input-group-addon left">CreatedDate</div>
	<input id="createdDate" name="createdDate" type="text" maxlength="255"  value="<?php echo $rows->createdDate;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="exportedDate">ExportedDate</label>
	<div class="input-group-addon left">ExportedDate</div>
	<input id="exportedDate" name="exportedDate" type="text" maxlength="255"  value="<?php echo $rows->exportedDate;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="postmarkedDate">PostmarkedDate</label>
	<div class="input-group-addon left">PostmarkedDate</div>
	<input name="postmarkedDate" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo $rows->postmarkedDate;?>" required/>
	</div>
	...
	<div class="form-group">
    <label class="control-label sr-only" for="effectiveDate">EffectiveDate</label>
	<div class="input-group-addon left">EffectiveDate</div>
	<input id="effectiveDate" name="effectiveDate" type="text" maxlength="255"  value="<?php echo $rows->effectiveDate;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="dateOfBirth">DateOfBirth</label>
	<div class="input-group-addon left">DateOfBirth</div>
	<input id="dateOfBirth" name="dateOfBirth" type="text" maxlength="255"  value="<?php echo $rows->dateOfBirth;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="cityStateZIP">CityStateZIP</label>
	<div class="input-group-addon left">CityStateZIP</div>
	<input id="cityStateZIP" name="cityStateZIP" type="text" maxlength="255"  value="<?php echo $rows->cityStateZIP;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="county">County</label>
	<div class="input-group-addon left">County</div>
	<input id="county" name="county" type="text" maxlength="255"  value="<?php echo $rows->county;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="homePhone">HomePhone</label>
	<div class="input-group-addon left">HomePhone</div>
	<input id="homePhone" name="homePhone" type="text" maxlength="255"  value="<?php echo $rows->homePhone;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="rxGroup">RxGroup</label>
	<div class="input-group-addon left">RxGroup</div>
	<input id="rxGroup" name="rxGroup" type="text" maxlength="255"  value="<?php echo $rows->rxGroup;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="coverageType">CoverageType</label>
	<div class="input-group-addon left">CoverageType</div>
	<input id="coverageType" name="coverageType" type="text" maxlength="255"  value="<?php echo $rows->coverageType;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="officeVisitCoPay">OfficeVisitCoPay</label>
	<div class="input-group-addon left">OfficeVisitCoPay</div>
	<input id="officeVisitCoPay" name="officeVisitCoPay" type="text" maxlength="255"  value="<?php echo $rows->officeVisitCoPay;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="eRCoPay">ERCoPay</label>
	<div class="input-group-addon left">ERCoPay</div>
	<input id="eRCoPay" name="eRCoPay" type="text" maxlength="255"  value="<?php echo $rows->eRCoPay;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="memberServicesPhone">MemberServicesPhone</label>
	<div class="input-group-addon left">MemberServicesPhone</div>
	<input id="memberServicesPhone" name="memberServicesPhone" type="text" maxlength="255"  value="<?php echo $rows->memberServicesPhone;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="tTYPhone">TTYPhone</label>
	<div class="input-group-addon left">TTYPhone</div>
	<input id="tTYPhone" name="tTYPhone" type="text" maxlength="255"  value="<?php echo $rows->tTYPhone;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="carrierNumber">CarrierNumber</label>
	<div class="input-group-addon left">CarrierNumber</div>
	<input id="carrierNumber" name="carrierNumber" type="text" maxlength="255"  value="<?php echo $rows->carrierNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="planName">PlanName</label>
	<div class="input-group-addon left">PlanName</div>
	<input id="planName" name="planName" type="text" maxlength="255"  value="<?php echo $rows->planName;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="pBPNumber">PBPNumber</label>
	<div class="input-group-addon left">PBPNumber</div>
	<input id="pBPNumber" name="pBPNumber" type="text" maxlength="255"  value="<?php echo $rows->pBPNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="providerName">ProviderName</label>
	<div class="input-group-addon left">ProviderName</div>
	<input id="providerName" name="providerName" type="text" maxlength="255"  value="<?php echo $rows->providerName;?>" class="form-control styler" required/>
	</div>
	...
	<input id="providerNumber" name="providerNumber" type="text" maxlength="255"  value="<?php echo $rows->providerNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="providerPhone">ProviderPhone</label>
	<div class="input-group-addon left">ProviderPhone</div>
	<input id="providerPhone" name="providerPhone" type="text" maxlength="255"  value="<?php echo $rows->providerPhone;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="defaultLanguage">DefaultLanguage</label>
	<div class="input-group-addon left">DefaultLanguage</div>
	<input id="defaultLanguage" name="defaultLanguage" type="text" maxlength="255"  value="<?php echo $rows->defaultLanguage;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="errorCode">ErrorCode</label>
	<div class="input-group-addon left">ErrorCode</div>
	<input id="errorCode" name="errorCode" type="text" maxlength="255"  value="<?php echo $rows->errorCode;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="errorDescription">ErrorDescription</label>
	<div class="input-group-addon left">ErrorDescription</div>
	<input id="errorDescription" name="errorDescription" type="text" maxlength="255"  value="<?php echo $rows->errorDescription;?>" class="form-control styler" required/>
	</div>
