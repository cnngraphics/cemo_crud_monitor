<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdatabadcockcollectionletters</p>';
	$excel.='
   ...
   $excel.='</table>';
	...
	$filename1= 'mailingdatabadcockcollectionletters_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdatabadcockcollectionletters_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdatabadcockcollectionletters_'.date('Y-m-d').'.pdf';
	if ($etype == 'word') 
    {
        MSWord($filename1);
        print $excel;
