	...
	*/
	...
	include(APP_FOLDER.'/views/admin/mailingdataavmedauthrecord/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mailingdataavmedauthrecord_model->SelectAll();
	include(APP_FOLDER.'/views/admin/mailingdataavmedauthrecord/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mailingdataavmedauthrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/mailingdataavmedauthrecord/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/admin/mailingdataavmedauthrecord/Add.php');
	}
	...
	json_send(''.H_ADMIN.'&view=mailingdataavmedauthrecord&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/admin/mailingdataavmedauthrecord/Update.php');
	}
	...
	json_send(''.H_ADMIN.'&view=mailingdataavmedauthrecord&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mailingdataavmedauthrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/mailingdataavmedauthrecord/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mailingdataavmedauthrecord_model->TruncateTable(''.H_ADMIN.'&view=mailingdataavmedauthrecord&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/admin/mailingdataavmedauthrecord/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mailingdataavmedauthrecord_model->Delete(get('id'),''.H_ADMIN.'&view=mailingdataavmedauthrecord&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_ADMIN.'&view=mailingdataavmedauthrecord&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
