	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatabadcockcollectionletters&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdatabadcockcollectionletters</h3></div>
  <div class="panel-body">
	...
	<input id="letterType" name="letterType" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="storeNumber" name="storeNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
