	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatasolstice&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mailingdatasolstice&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatasolstice&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatasolstice&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mailingdatasolstice</h3></div>
  <div class="panel-body">
	...
	<div class="form-group">
    <label class="control-label sr-only" for="groupNo">GroupNo</label>
	<div class="input-group-addon left">GroupNo</div>
	<input id="groupNo" name="groupNo" type="text" maxlength="255"  value="<?php echo $rows->groupNo;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="idCardReq">IdCardReq</label>
	<div class="input-group-addon left">IdCardReq</div>
	<input id="idCardReq" name="idCardReq" type="text" maxlength="255"  value="<?php echo $rows->idCardReq;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="groupName">GroupName</label>
	<div class="input-group-addon left">GroupName</div>
	<input id="groupName" name="groupName" type="text" maxlength="255"  value="<?php echo $rows->groupName;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="altId">AltId</label>
	<div class="input-group-addon left">AltId</div>
	<input id="altId" name="altId" type="text" maxlength="255"  value="<?php echo $rows->altId;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="ovrpPopLn">OvrpPopLn</label>
	<div class="input-group-addon left">OvrpPopLn</div>
	<input id="ovrpPopLn" name="ovrpPopLn" type="text" maxlength="255"  value="<?php echo $rows->ovrpPopLn;?>" class="form-control styler" required/>
	</div>
	...
	<input name="effectiveDate" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo $rows->effectiveDate;?>" required/>
	</div>
	...
	<div class="form-group">
    <label class="control-label sr-only" for="kitCode">KitCode</label>
	<div class="input-group-addon left">KitCode</div>
	<input id="kitCode" name="kitCode" type="text" maxlength="11"  value="<?php echo $rows->kitCode;?>" class="form-control styler" required/>
	</div>
	...
	<input name="mmCOAMoveToDate" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo $rows->mmCOAMoveToDate;?>" required/>
	</div>
