	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataaltegrarpc1&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdataaltegrarpc1</h3></div>
  <div class="panel-body">
	...
	<input id="RUNTIME_MailBarCode" name="RUNTIME_MailBarCode" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="batchID">BatchID</label>
	<div class="input-group-addon left">BatchID</div>
	<input id="batchID" name="batchID" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="original_filename" name="original_filename" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="fileNameTemplate" name="fileNameTemplate" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="includeInTest" name="includeInTest" type="text" maxlength="1"  value="" class="form-control styler" required/>
	</div>
