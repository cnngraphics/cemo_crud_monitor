	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatabadcockstatements&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdatabadcockstatements</h3></div>
  <div class="panel-body">
	...
	<input id="recordId" name="recordId" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="customerNumber" name="customerNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="beginningCycle" name="beginningCycle" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="endingCycle">EndingCycle</label>
	<div class="input-group-addon left">EndingCycle</div>
	<input id="endingCycle" name="endingCycle" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="storeNumber">StoreNumber</label>
	<div class="input-group-addon left">StoreNumber</div>
	<input id="storeNumber" name="storeNumber" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="cycle">Cycle</label>
	<div class="input-group-addon left">Cycle</div>
	<input id="cycle" name="cycle" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="deliveryMethod" name="deliveryMethod" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="qc" name="qc" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
