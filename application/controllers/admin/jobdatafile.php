	...
	*/
	...
	include(APP_FOLDER.'/views/admin/jobdatafile/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->jobdatafile_model->SelectAll();
	include(APP_FOLDER.'/views/admin/jobdatafile/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->jobdatafile_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/jobdatafile/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/admin/jobdatafile/Add.php');
	}
	...
	json_send(''.H_ADMIN.'&view=jobdatafile&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/admin/jobdatafile/Update.php');
	}
	...
	json_send(''.H_ADMIN.'&view=jobdatafile&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->jobdatafile_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/jobdatafile/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->jobdatafile_model->TruncateTable(''.H_ADMIN.'&view=jobdatafile&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/admin/jobdatafile/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->jobdatafile_model->Delete(get('id'),''.H_ADMIN.'&view=jobdatafile&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_ADMIN.'&view=jobdatafile&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
