<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdataavmed</p>';
	...
	<tr>
      ...
      <th>MailingDataAvmedRecord Id</th>
      <th>PdfTotPages</th>
  ...
  ';
	...
	<td>'.$rows->mailingDataAvmedRecord_id.'</td>
	...
	$excel.='</table>';
	$filename1= 'mailingdataavmed_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdataavmed_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdataavmed_'.date('Y-m-d').'.pdf';
