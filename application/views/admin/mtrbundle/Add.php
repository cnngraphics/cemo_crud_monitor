	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_ADMIN_MAIN.'&view=mtrbundle&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mtrbundle</h3></div>
  <div class="panel-body">
	...
	<input id="deviceId" name="deviceId" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="edocPackageId" name="edocPackageId" type="text" maxlength="6"  value="" class="form-control styler" required/>
	</div>
