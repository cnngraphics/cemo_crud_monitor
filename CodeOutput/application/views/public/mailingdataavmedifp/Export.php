<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdataavmedifp</p>';
  ...
  ';
	...
	$excel.='</table>';
	$filename1= 'mailingdataavmedifp_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdataavmedifp_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdataavmedifp_'.date('Y-m-d').'.pdf';
