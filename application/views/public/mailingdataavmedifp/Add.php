	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmedifp&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdataavmedifp</h3></div>
  <div class="panel-body">
	...
	<input name="dueDate" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo date('Y-m-d');?>" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="toDate">ToDate</label>
	<div class="input-group-addon left">ToDate</div>
	<input name="toDate" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo date('Y-m-d');?>" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="receivedBy">ReceivedBy</label>
	<div class="input-group-addon left">ReceivedBy</div>
	<input name="receivedBy" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo date('Y-m-d');?>" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="agent">Agent</label>
	<div class="input-group-addon left">Agent</div>
	<input id="agent" name="agent" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
