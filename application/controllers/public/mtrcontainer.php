	...
	*/
	...
	include(APP_FOLDER.'/views/public/mtrcontainer/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mtrcontainer_model->SelectAll();
	include(APP_FOLDER.'/views/public/mtrcontainer/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mtrcontainer_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mtrcontainer/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/public/mtrcontainer/Add.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mtrcontainer&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/public/mtrcontainer/Update.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mtrcontainer&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mtrcontainer_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mtrcontainer/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mtrcontainer_model->TruncateTable(''.H_CLIENT.'&view=mtrcontainer&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/public/mtrcontainer/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mtrcontainer_model->Delete(get('id'),''.H_CLIENT.'&view=mtrcontainer&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_CLIENT.'&view=mtrcontainer&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
