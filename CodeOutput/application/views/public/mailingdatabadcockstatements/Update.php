	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatabadcockstatements&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mailingdatabadcockstatements&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatabadcockstatements&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatabadcockstatements&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mailingdatabadcockstatements</h3></div>
  <div class="panel-body">
	...
	<input id="recordId" name="recordId" type="text" maxlength="11"  value="<?php echo $rows->recordId;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="customerNumber">CustomerNumber</label>
	<div class="input-group-addon left">CustomerNumber</div>
	<input id="customerNumber" name="customerNumber" type="text" maxlength="255"  value="<?php echo $rows->customerNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="beginningCycle">BeginningCycle</label>
	<div class="input-group-addon left">BeginningCycle</div>
	<input id="beginningCycle" name="beginningCycle" type="text" maxlength="255"  value="<?php echo $rows->beginningCycle;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="endingCycle">EndingCycle</label>
	<div class="input-group-addon left">EndingCycle</div>
	<input id="endingCycle" name="endingCycle" type="text" maxlength="255"  value="<?php echo $rows->endingCycle;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="storeNumber">StoreNumber</label>
	<div class="input-group-addon left">StoreNumber</div>
	<input id="storeNumber" name="storeNumber" type="text" maxlength="11"  value="<?php echo $rows->storeNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="cycle">Cycle</label>
	<div class="input-group-addon left">Cycle</div>
	<input id="cycle" name="cycle" type="text" maxlength="11"  value="<?php echo $rows->cycle;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="deliveryMethod">DeliveryMethod</label>
	<div class="input-group-addon left">DeliveryMethod</div>
	<input id="deliveryMethod" name="deliveryMethod" type="text" maxlength="255"  value="<?php echo $rows->deliveryMethod;?>" class="form-control styler" required/>
	</div>
	...
	<input id="mailingDataRecord_id" name="mailingDataRecord_id" type="text" maxlength="20"  value="<?php echo $rows->mailingDataRecord_id;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="qc">Qc</label>
	<div class="input-group-addon left">Qc</div>
	<input id="qc" name="qc" type="text" maxlength="11"  value="<?php echo $rows->qc;?>" class="form-control styler" required/>
	</div>
