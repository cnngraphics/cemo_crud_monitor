	...
	*/
	...
	include(APP_FOLDER.'/views/admin/mailingdataprincess/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mailingdataprincess_model->SelectAll();
	include(APP_FOLDER.'/views/admin/mailingdataprincess/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mailingdataprincess_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/mailingdataprincess/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/admin/mailingdataprincess/Add.php');
	}
	...
	json_send(''.H_ADMIN.'&view=mailingdataprincess&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/admin/mailingdataprincess/Update.php');
	}
	...
	json_send(''.H_ADMIN.'&view=mailingdataprincess&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mailingdataprincess_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/mailingdataprincess/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mailingdataprincess_model->TruncateTable(''.H_ADMIN.'&view=mailingdataprincess&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/admin/mailingdataprincess/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mailingdataprincess_model->Delete(get('id'),''.H_ADMIN.'&view=mailingdataprincess&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_ADMIN.'&view=mailingdataprincess&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
