	...
	/*
	* =======================================================================
	* CLASSNAME:        mailingdatahealthsunmemberquarterlyeob_model
	...
	*/
	...
	include_once(APP_FOLDER.'/models/classes/class_mailingdatahealthsunmemberquarterlyeob.php');
	
	class mailingdatahealthsunmemberquarterlyeob_model{
	...
	return HDB::hus()->Hselect("mailingdatahealthsunmemberquarterlyeob LIMIT {$startpg} , {$limit}");
	}else{
	return HDB::hus()->Hselect("mailingdatahealthsunmemberquarterlyeob");	
	}
	}
	...
	{
	return HDB::hus()->Hcount("mailingdatahealthsunmemberquarterlyeob");
	}
	...
	{
	$bind = array(":id" =>$id);
	return HDB::hus()->Hone("mailingdatahealthsunmemberquarterlyeob","id=:id",$bind);
	}
	...
	return HDB::hus()->Hselect("mailingdatahealthsunmemberquarterlyeob","$where LIKE :svalue LIMIT $limit",$bind);		
	}
	
	// TRUNCATE TABLE
	public function TruncateTable($redirect_to)
	{
   	$sql=HDB::hus()->prepare("TRUNCATE mailingdatahealthsunmemberquarterlyeob");
	$sql->execute();
	send_to($redirect_to);
	}
	...
	{
	$bind = array(":id" =>$id);
	HDB::hus()->Hdelete("mailingdatahealthsunmemberquarterlyeob","id=:id",$bind);
	send_to($redirect_to);
	}
	...
	HDB::hus()->Hinsert('mailingdatahealthsunmemberquarterlyeob', $values);
	}
	...
	HDB::hus()->Hupdate('mailingdatahealthsunmemberquarterlyeob',$sql,$data);
