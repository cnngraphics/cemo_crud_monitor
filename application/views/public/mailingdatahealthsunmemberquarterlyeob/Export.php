<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdatahealthsunmemberquarterlyeob</p>';
  ...
  ';
	...
	$excel.='</table>';
	$filename1= 'mailingdatahealthsunmemberquarterlyeob_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdatahealthsunmemberquarterlyeob_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdatahealthsunmemberquarterlyeob_'.date('Y-m-d').'.pdf';
