	...
	*/
	...
	include(APP_FOLDER.'/views/public/mailingdataavmedrecord/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mailingdataavmedrecord_model->SelectAll();
	include(APP_FOLDER.'/views/public/mailingdataavmedrecord/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mailingdataavmedrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdataavmedrecord/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/public/mailingdataavmedrecord/Add.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdataavmedrecord&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/public/mailingdataavmedrecord/Update.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdataavmedrecord&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mailingdataavmedrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdataavmedrecord/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mailingdataavmedrecord_model->TruncateTable(''.H_CLIENT.'&view=mailingdataavmedrecord&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/public/mailingdataavmedrecord/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mailingdataavmedrecord_model->Delete(get('id'),''.H_CLIENT.'&view=mailingdataavmedrecord&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_CLIENT.'&view=mailingdataavmedrecord&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
