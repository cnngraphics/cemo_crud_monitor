	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmedgroupinvoices&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdataavmedgroupinvoices</h3></div>
  <div class="panel-body">
	...
	<input id="mailingDataRecord10_id" name="mailingDataRecord10_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="mailingDataRecord20_id" name="mailingDataRecord20_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="mailingDataRecord21_id" name="mailingDataRecord21_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="mailingDataRecord30_id" name="mailingDataRecord30_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="mailingDataRecord40_id" name="mailingDataRecord40_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="mailingDataRecord50_id" name="mailingDataRecord50_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
