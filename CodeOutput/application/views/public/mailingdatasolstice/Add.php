	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatasolstice&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdatasolstice</h3></div>
  <div class="panel-body">
	...
	<input id="groupNo" name="groupNo" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="idCardReq">IdCardReq</label>
	<div class="input-group-addon left">IdCardReq</div>
	<input id="idCardReq" name="idCardReq" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="groupName">GroupName</label>
	<div class="input-group-addon left">GroupName</div>
	<input id="groupName" name="groupName" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="altId">AltId</label>
	<div class="input-group-addon left">AltId</div>
	<input id="altId" name="altId" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="ovrpPopLn">OvrpPopLn</label>
	<div class="input-group-addon left">OvrpPopLn</div>
	<input id="ovrpPopLn" name="ovrpPopLn" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input name="effectiveDate" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo date('Y-m-d');?>" required/>
	</div>
	...
	<input id="kitCode" name="kitCode" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input name="mmCOAMoveToDate" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo date('Y-m-d');?>" required/>
	</div>
