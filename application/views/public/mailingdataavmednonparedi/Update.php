	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmednonparedi&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mailingdataavmednonparedi&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdataavmednonparedi&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdataavmednonparedi&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mailingdataavmednonparedi</h3></div>
  <div class="panel-body">
	...
	<div class="form-group">
    <label class="control-label sr-only" for="transmissionDate">TransmissionDate</label>
	<div class="input-group-addon left">TransmissionDate</div>
	<input name="transmissionDate" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo $rows->transmissionDate;?>" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="claimNumber">ClaimNumber</label>
	<div class="input-group-addon left">ClaimNumber</div>
	<input id="claimNumber" name="claimNumber" type="text" maxlength="255"  value="<?php echo $rows->claimNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="providerTaxId">ProviderTaxId</label>
	<div class="input-group-addon left">ProviderTaxId</div>
	<input id="providerTaxId" name="providerTaxId" type="text" maxlength="11"  value="<?php echo $rows->providerTaxId;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="providerNPI">ProviderNPI</label>
	<div class="input-group-addon left">ProviderNPI</div>
	<input id="providerNPI" name="providerNPI" type="text" maxlength="11"  value="<?php echo $rows->providerNPI;?>" class="form-control styler" required/>
	</div>
	...
	<div class="form-group">
    <label class="control-label sr-only" for="memberName">MemberName</label>
	<div class="input-group-addon left">MemberName</div>
	<input id="memberName" name="memberName" type="text" maxlength="255"  value="<?php echo $rows->memberName;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="service">Service</label>
	<div class="input-group-addon left">Service</div>
	<input id="service" name="service" type="text" maxlength="255"  value="<?php echo $rows->service;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="DIAG1">DIAG1</label>
	<div class="input-group-addon left">DIAG1</div>
	<input id="DIAG1" name="DIAG1" type="text" maxlength="255"  value="<?php echo $rows->DIAG1;?>" class="form-control styler" required/>
	</div>
