	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_ADMIN_MAIN.'&view=mailingdataavmedgroupinvoicesrecord40&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_CREATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_CREATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_ADMIN;?>&view=mailingdataavmedgroupinvoicesrecord40&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdataavmedgroupinvoicesrecord40</h3></div>
  <div class="panel-body">
	...
	<input id="adjEffDate" name="adjEffDate" type="text" maxlength="8"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="adjEndDate">AdjEndDate</label>
	<div class="input-group-addon left">AdjEndDate</div>
	<input id="adjEndDate" name="adjEndDate" type="text" maxlength="8"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="adjContType">AdjContType</label>
	<div class="input-group-addon left">AdjContType</div>
	<input id="adjContType" name="adjContType" type="text" maxlength="2"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="adjRemark">AdjRemark</label>
	<div class="input-group-addon left">AdjRemark</div>
	<input id="adjRemark" name="adjRemark" type="text" maxlength="16"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="adjAmount">AdjAmount</label>
	<div class="input-group-addon left">AdjAmount</div>
	<input id="adjAmount" name="adjAmount" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="nbrDaysMonths" name="nbrDaysMonths" type="text" maxlength="3"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry1" name="adjAmountEntry1" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry2" name="adjAmountEntry2" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry3" name="adjAmountEntry3" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry4" name="adjAmountEntry4" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry5" name="adjAmountEntry5" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry6" name="adjAmountEntry6" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry7" name="adjAmountEntry7" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry8" name="adjAmountEntry8" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry9" name="adjAmountEntry9" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry10" name="adjAmountEntry10" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry11" name="adjAmountEntry11" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="adjAmountEntry12" name="adjAmountEntry12" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
