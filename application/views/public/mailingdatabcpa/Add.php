	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatabcpa&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdatabcpa</h3></div>
  <div class="panel-body">
	...
	<input id="domestic" name="domestic" type="text" maxlength="1"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="documentDate">DocumentDate</label>
	<div class="input-group-addon left">DocumentDate</div>
	<input name="documentDate" class="datepicker form-control styler" type="text" maxlength="1" value="<?php echo date('Y-m-d');?>" required/>
	</div>
	...
	<input id="mailingDataBCPARecord_id" name="mailingDataBCPARecord_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="qrCode" name="qrCode" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
