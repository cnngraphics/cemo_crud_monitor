	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_ADMIN_MAIN.'&view=mailingdataavmedgroupinvoices&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
