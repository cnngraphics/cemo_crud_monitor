	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_ADMIN_MAIN.'&view=mtrhandlingunit&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_ADMIN;?>&view=mtrhandlingunit&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_ADMIN;?>&view=mtrhandlingunit&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_ADMIN;?>&view=mtrhandlingunit&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mtrhandlingunit</h3></div>
  <div class="panel-body">
	...
	<input id="appointmentId" name="appointmentId" type="text" maxlength="15"  value="<?php echo $rows->appointmentId;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="bundleCount">BundleCount</label>
	<div class="input-group-addon left">BundleCount</div>
	<input id="bundleCount" name="bundleCount" type="text" maxlength="5"  value="<?php echo $rows->bundleCount;?>" class="form-control styler" required/>
	</div>
	...
	<input id="edocContainerId" name="edocContainerId" type="text" maxlength="6"  value="<?php echo $rows->edocContainerId;?>" class="form-control styler" required/>
	</div>
	...
	<input id="edocCsaAgreementId" name="edocCsaAgreementId" type="text" maxlength="10"  value="<?php echo $rows->edocCsaAgreementId;?>" class="form-control styler" required/>
	</div>
	...
	<input id="edocCustomerGroupId" name="edocCustomerGroupId" type="text" maxlength="12"  value="<?php echo $rows->edocCustomerGroupId;?>" class="form-control styler" required/>
	</div>
	...
	<input id="edocParentContainerId" name="edocParentContainerId" type="text" maxlength="6"  value="<?php echo $rows->edocParentContainerId;?>" class="form-control styler" required/>
	</div>
	...
	<input id="edocSiblingContainerId" name="edocSiblingContainerId" type="text" maxlength="6"  value="<?php echo $rows->edocSiblingContainerId;?>" class="form-control styler" required/>
	</div>
	...
	<input id="edocUserLicenseCode" name="edocUserLicenseCode" type="text" maxlength="4"  value="<?php echo $rows->edocUserLicenseCode;?>" class="form-control styler" required/>
	</div>
	...
	<input id="imtb" name="imtb" type="text" maxlength="24"  value="<?php echo $rows->imtb;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="imtbCin">ImtbCin</label>
	<div class="input-group-addon left">ImtbCin</div>
	<input id="imtbCin" name="imtbCin" type="text" maxlength="3"  value="<?php echo $rows->imtbCin;?>" class="form-control styler" required/>
	</div>
	...
	<input id="imtbDestinationZip" name="imtbDestinationZip" type="text" maxlength="5"  value="<?php echo $rows->imtbDestinationZip;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="imtbMid">ImtbMid</label>
	<div class="input-group-addon left">ImtbMid</div>
	<input id="imtbMid" name="imtbMid" type="text" maxlength="9"  value="<?php echo $rows->imtbMid;?>" class="form-control styler" required/>
	</div>
	...
	<input id="imtbProcessingCode" name="imtbProcessingCode" type="text" maxlength="1"  value="<?php echo $rows->imtbProcessingCode;?>" class="form-control styler" required/>
	</div>
	...
	<input id="imtbSerialNumber" name="imtbSerialNumber" type="text" maxlength="8"  value="<?php echo $rows->imtbSerialNumber;?>" class="form-control styler" required/>
	</div>
	...
	<input id="pieceCount" name="pieceCount" type="text" maxlength="8"  value="<?php echo $rows->pieceCount;?>" class="form-control styler" required/>
	</div>
