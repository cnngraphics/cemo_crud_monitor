	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatahealthsunidcards&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdatahealthsunidcards</h3></div>
  <div class="panel-body">
	...
	<input id="memberPBPID" name="memberPBPID" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="createdDate">CreatedDate</label>
	<div class="input-group-addon left">CreatedDate</div>
	<input id="createdDate" name="createdDate" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="exportedDate">ExportedDate</label>
	<div class="input-group-addon left">ExportedDate</div>
	<input id="exportedDate" name="exportedDate" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input name="postmarkedDate" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo date('Y-m-d');?>" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="memberNumber">MemberNumber</label>
	<div class="input-group-addon left">MemberNumber</div>
	<input id="memberNumber" name="memberNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="effectiveDate" name="effectiveDate" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="dateOfBirth">DateOfBirth</label>
	<div class="input-group-addon left">DateOfBirth</div>
	<input id="dateOfBirth" name="dateOfBirth" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="cityStateZIP">CityStateZIP</label>
	<div class="input-group-addon left">CityStateZIP</div>
	<input id="cityStateZIP" name="cityStateZIP" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="county">County</label>
	<div class="input-group-addon left">County</div>
	<input id="county" name="county" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="homePhone">HomePhone</label>
	<div class="input-group-addon left">HomePhone</div>
	<input id="homePhone" name="homePhone" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="rxGroup">RxGroup</label>
	<div class="input-group-addon left">RxGroup</div>
	<input id="rxGroup" name="rxGroup" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="coverageType">CoverageType</label>
	<div class="input-group-addon left">CoverageType</div>
	<input id="coverageType" name="coverageType" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="officeVisitCoPay" name="officeVisitCoPay" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="eRCoPay">ERCoPay</label>
	<div class="input-group-addon left">ERCoPay</div>
	<input id="eRCoPay" name="eRCoPay" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="memberServicesPhone" name="memberServicesPhone" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="tTYPhone">TTYPhone</label>
	<div class="input-group-addon left">TTYPhone</div>
	<input id="tTYPhone" name="tTYPhone" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="carrierNumber" name="carrierNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="planName">PlanName</label>
	<div class="input-group-addon left">PlanName</div>
	<input id="planName" name="planName" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="pBPNumber">PBPNumber</label>
	<div class="input-group-addon left">PBPNumber</div>
	<input id="pBPNumber" name="pBPNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="providerName">ProviderName</label>
	<div class="input-group-addon left">ProviderName</div>
	<input id="providerName" name="providerName" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="providerNumber" name="providerNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="providerPhone" name="providerPhone" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="defaultLanguage" name="defaultLanguage" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="errorCode">ErrorCode</label>
	<div class="input-group-addon left">ErrorCode</div>
	<input id="errorCode" name="errorCode" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="errorDescription" name="errorDescription" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
