	...
	*/
	...
	include(APP_FOLDER.'/views/public/mailingdataavmedmedeobrecord/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mailingdataavmedmedeobrecord_model->SelectAll();
	include(APP_FOLDER.'/views/public/mailingdataavmedmedeobrecord/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mailingdataavmedmedeobrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdataavmedmedeobrecord/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/public/mailingdataavmedmedeobrecord/Add.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdataavmedmedeobrecord&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/public/mailingdataavmedmedeobrecord/Update.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdataavmedmedeobrecord&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mailingdataavmedmedeobrecord_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdataavmedmedeobrecord/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mailingdataavmedmedeobrecord_model->TruncateTable(''.H_CLIENT.'&view=mailingdataavmedmedeobrecord&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/public/mailingdataavmedmedeobrecord/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mailingdataavmedmedeobrecord_model->Delete(get('id'),''.H_CLIENT.'&view=mailingdataavmedmedeobrecord&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_CLIENT.'&view=mailingdataavmedmedeobrecord&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
