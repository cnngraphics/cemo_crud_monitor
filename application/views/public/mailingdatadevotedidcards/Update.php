	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdatadevotedidcards&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mailingdatadevotedidcards&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatadevotedidcards&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mailingdatadevotedidcards&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mailingdatadevotedidcards</h3></div>
  <div class="panel-body">
	...
	<input id="memberId" name="memberId" type="text" maxlength="255"  value="<?php echo $rows->memberId;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="address3">Address3</label>
	<div class="input-group-addon left">Address3</div>
	<input id="address3" name="address3" type="text" maxlength="255"  value="<?php echo $rows->address3;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="pbpName">PbpName</label>
	<div class="input-group-addon left">PbpName</div>
	<input id="pbpName" name="pbpName" type="text" maxlength="255"  value="<?php echo $rows->pbpName;?>" class="form-control styler" required/>
	</div>
	...
	<div class="form-group">
    <label class="control-label sr-only" for="pcpName">PcpName</label>
	<div class="input-group-addon left">PcpName</div>
	<input id="pcpName" name="pcpName" type="text" maxlength="255"  value="<?php echo $rows->pcpName;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="language">Language</label>
	<div class="input-group-addon left">Language</div>
	<input id="language" name="language" type="text" maxlength="255"  value="<?php echo $rows->language;?>" class="form-control styler" required/>
	</div>
	...
	<input id="recordId" name="recordId" type="text" maxlength="255"  value="<?php echo $rows->recordId;?>" class="form-control styler" required/>
	</div>
	...
	<div class="form-group">
    <label class="control-label sr-only" for="completeDate">CompleteDate</label>
	<div class="input-group-addon left">CompleteDate</div>
	<input name="completeDate" class="datepicker form-control styler" type="text" maxlength="20" value="<?php echo $rows->completeDate;?>" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="trackingNumber">TrackingNumber</label>
	<div class="input-group-addon left">TrackingNumber</div>
	<input id="trackingNumber" name="trackingNumber" type="text" maxlength="255"  value="<?php echo $rows->trackingNumber;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="shipError">ShipError</label>
	<div class="input-group-addon left">ShipError</div>
	<input id="shipError" name="shipError" type="text" maxlength="255"  value="<?php echo $rows->shipError;?>" class="form-control styler" required/>
	</div>
