<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdataavmedrenewal</p>';
	$excel.='
   ...
   $excel.='</table>';
	...
	$filename1= 'mailingdataavmedrenewal_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdataavmedrenewal_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdataavmedrenewal_'.date('Y-m-d').'.pdf';
	if ($etype == 'word') 
    {
        MSWord($filename1);
        print $excel;
