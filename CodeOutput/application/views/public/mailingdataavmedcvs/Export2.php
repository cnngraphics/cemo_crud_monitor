<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdataavmedcvs</p>';
	$excel.='
   ...
   $excel.='</table>';
	...
	$filename1= 'mailingdataavmedcvs_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdataavmedcvs_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdataavmedcvs_'.date('Y-m-d').'.pdf';
	if ($etype == 'word') 
    {
        MSWord($filename1);
        print $excel;
