	...
	*/
	...
	include(APP_FOLDER.'/views/public/mtrbundle/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mtrbundle_model->SelectAll();
	include(APP_FOLDER.'/views/public/mtrbundle/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mtrbundle_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mtrbundle/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/public/mtrbundle/Add.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mtrbundle&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/public/mtrbundle/Update.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mtrbundle&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mtrbundle_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mtrbundle/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mtrbundle_model->TruncateTable(''.H_CLIENT.'&view=mtrbundle&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/public/mtrbundle/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mtrbundle_model->Delete(get('id'),''.H_CLIENT.'&view=mtrbundle&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_CLIENT.'&view=mtrbundle&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
