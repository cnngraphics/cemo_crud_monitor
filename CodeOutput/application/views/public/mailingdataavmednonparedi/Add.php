	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmednonparedi&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdataavmednonparedi</h3></div>
  <div class="panel-body">
	...
	<input name="transmissionDate" class="datepicker form-control styler" type="text" maxlength="11" value="<?php echo date('Y-m-d');?>" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="claimNumber">ClaimNumber</label>
	<div class="input-group-addon left">ClaimNumber</div>
	<input id="claimNumber" name="claimNumber" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="providerTaxId" name="providerTaxId" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="providerNPI">ProviderNPI</label>
	<div class="input-group-addon left">ProviderNPI</div>
	<input id="providerNPI" name="providerNPI" type="text" maxlength="11"  value="" class="form-control styler" required/>
	</div>
	...
	<input id="memberName" name="memberName" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="service">Service</label>
	<div class="input-group-addon left">Service</div>
	<input id="service" name="service" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="DIAG1">DIAG1</label>
	<div class="input-group-addon left">DIAG1</div>
	<input id="DIAG1" name="DIAG1" type="text" maxlength="255"  value="" class="form-control styler" required/>
	</div>
