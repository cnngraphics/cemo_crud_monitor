...
//Get path
$base = str_replace('libraries\\tinymce\\js\\tinymce\\plugins\\jbimages','',dirname(__FILE__));
$mbase = str_replace('\\','/',$base);
$mbasedd = str_replace('/libraries/tinymce/js/tinymce/plugins/jbimages','',$mbase );
include($mbasedd .'/config/config.php');
...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = H_EDITOR_FILES; // Relative to domain name
