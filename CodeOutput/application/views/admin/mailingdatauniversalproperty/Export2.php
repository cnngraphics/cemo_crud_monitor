<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdatauniversalproperty</p>';
	$excel.='
   ...
   $excel.='</table>';
	...
	$filename1= 'mailingdatauniversalproperty_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdatauniversalproperty_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdatauniversalproperty_'.date('Y-m-d').'.pdf';
	if ($etype == 'word') 
    {
        MSWord($filename1);
        print $excel;
