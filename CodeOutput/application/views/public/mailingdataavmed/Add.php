	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mailingdataavmed&do=addpro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Mailingdataavmed</h3></div>
  <div class="panel-body">
	...
	<input id="mailingDataAvmedRecord_id" name="mailingDataAvmedRecord_id" type="text" maxlength="20"  value="" class="form-control styler" required/>
	</div>
