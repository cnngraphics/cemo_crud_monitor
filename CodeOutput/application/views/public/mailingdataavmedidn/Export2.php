<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdataavmedidn</p>';
	$excel.='
    ...
    <tr>
	<td>MailingDataAvmedIDNRecord Id</td>
	<td>'.$rows->mailingDataAvmedIDNRecord_id.'</td>
  	</tr>
    <tr>
	<td>Generic1</td>
	<td>'.$rows->generic1.'</td>
   ...
   $excel.='</table>';
	...
	$filename1= 'mailingdataavmedidn_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdataavmedidn_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdataavmedidn_'.date('Y-m-d').'.pdf';
	if ($etype == 'word') 
    {
        MSWord($filename1);
        print $excel;
