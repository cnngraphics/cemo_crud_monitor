  ...
  <div class="panel-body pformmargin">
	 ...
	 <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post" name="hezecomform" id="" enctype="multipart/form-data">
	...
	<option value="<?php echo $rows->user_status;?>"><?php echo check_status($rows->user_status);?></option>
	...
	<option value="<?php echo $rows->user_position;?>"><?php echo check_position($rows->user_position);?></option>
	...
	<a href="<?php echo H_ADMIN;?>&view=hsys_users&userid=<?php echo $rows->userid;?>&dfile=<?php echo $rows->user_avarta;?>&do=delete&fdel=file" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><span class="btn btn-xs btn-danger"><i class="fa fa-remove"></i> <?php echo LANG_DELETE;?></span></a><br><?php }?>
