<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdataavmedncoa</p>';
  ...
  ';
	...
	$excel.='</table>';
	$filename1= 'mailingdataavmedncoa_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdataavmedncoa_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdataavmedncoa_'.date('Y-m-d').'.pdf';
