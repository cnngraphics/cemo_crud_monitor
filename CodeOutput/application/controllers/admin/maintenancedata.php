	...
	*/
	...
	include(APP_FOLDER.'/views/admin/maintenancedata/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->maintenancedata_model->SelectAll();
	include(APP_FOLDER.'/views/admin/maintenancedata/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->maintenancedata_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/maintenancedata/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/admin/maintenancedata/Add.php');
	}
	...
	json_send(''.H_ADMIN.'&view=maintenancedata&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/admin/maintenancedata/Update.php');
	}
	...
	json_send(''.H_ADMIN.'&view=maintenancedata&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->maintenancedata_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/admin/maintenancedata/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->maintenancedata_model->TruncateTable(''.H_ADMIN.'&view=maintenancedata&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/admin/maintenancedata/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->maintenancedata_model->Delete(get('id'),''.H_ADMIN.'&view=maintenancedata&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_ADMIN.'&view=maintenancedata&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
