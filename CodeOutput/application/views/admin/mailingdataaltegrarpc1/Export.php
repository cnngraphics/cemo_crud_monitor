<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdataaltegrarpc1</p>';
	...
	<tr>
      ...
      <th>PdfLocation</th>
      <th>PdfTotPages</th>
      <th>RUNTIME MailBarCode</th>
      <th>BatchID</th>
      <th>Original Filename</th>
      <th>FileNameTemplate</th>
      <th>IncludeInTest</th>
  ...
  ';
	...
	<td>'.$rows->RUNTIME_MailBarCode.'</td>
	<td>'.$rows->batchID.'</td>
	<td>'.$rows->original_filename.'</td>
	<td>'.$rows->fileNameTemplate.'</td>
	<td>'.$rows->includeInTest.'</td>
	...
	$excel.='</table>';
	$filename1= 'mailingdataaltegrarpc1_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdataaltegrarpc1_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdataaltegrarpc1_'.date('Y-m-d').'.pdf';
