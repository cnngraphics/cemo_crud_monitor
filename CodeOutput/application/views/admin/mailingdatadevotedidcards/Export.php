<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdatadevotedidcards</p>';
  ...
  ';
	...
	<td>'.$rows->completeDate.'</td>
	<td>'.$rows->trackingNumber.'</td>
	<td>'.$rows->shipError.'</td>
	</tr>';
	}
	$excel.='</table>';
	$filename1= 'mailingdatadevotedidcards_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdatadevotedidcards_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdatadevotedidcards_'.date('Y-m-d').'.pdf';
