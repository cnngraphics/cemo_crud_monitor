<?php
	...
	<strong>'.LANG_REPORT_TABLE.'</strong> Mailingdatahealthsunpartdeob</p>';
  ...
  ';
	...
	$excel.='</table>';
	$filename1= 'mailingdatahealthsunpartdeob_'.date('Y-m-d').'.doc';
	$filename2= 'mailingdatahealthsunpartdeob_'.date('Y-m-d').'.xls';
	$pdf_output= 'mailingdatahealthsunpartdeob_'.date('Y-m-d').'.pdf';
