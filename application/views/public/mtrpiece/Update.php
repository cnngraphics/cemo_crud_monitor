	...
	*/
	...
	?>
	 ...
	 <form action="<?php echo H_CLIENT_MAIN.'&view=mtrpiece&do=updatepro';?>" method="post" name="hezecomform" id="hezecomform" enctype="multipart/form-data">
	<div class="col-12">
	<ul class="nav pull-right" style="margin-top:5px;">
	  <label for="hButton" class="btn btn-info btn-sm" style="color:#FFF;"><i class="fa fa-floppy-o"></i> <?php echo LANG_UPDATE_RECORD;?></label>
	 <input type="submit" name="button" id="hButton" class="hidden" value="<?php echo LANG_UPDATE_RECORD;?>" />
	 	 
	  <a href="<?php echo H_CLIENT;?>&view=mtrpiece&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mtrpiece&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
	
	<a href="<?php echo H_CLIENT;?>&view=mtrpiece&do=viewall" class="btn btn-default btn-sm tip" title="<?php echo LANG_TIP_VIEWALL;?>"><i class="fa fa-reply"></i> <?php echo LANG_GO_BACK;?></a>
	</ul>
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Mtrpiece</h3></div>
  <div class="panel-body">
	...
	<input id="idTag" name="idTag" type="text" maxlength="20"  value="<?php echo $rows->idTag;?>" class="form-control styler" required/>
	</div>
	...
	<input id="ldeDeliveryMode" name="ldeDeliveryMode" type="text" maxlength="50"  value="<?php echo $rows->ldeDeliveryMode;?>" class="form-control styler" required/>
	</div>
	...
	<input id="ldeInventoryMethod" name="ldeInventoryMethod" type="text" maxlength="50"  value="<?php echo $rows->ldeInventoryMethod;?>" class="form-control styler" required/>
	</div>
	...
	<input id="ldeTriggerMethod" name="ldeTriggerMethod" type="text" maxlength="50"  value="<?php echo $rows->ldeTriggerMethod;?>" class="form-control styler" required/>
	</div>

	<div class="form-group">
    <label class="control-label sr-only" for="machineId">MachineId</label>
	<div class="input-group-addon left">MachineId</div>
	<input id="machineId" name="machineId" type="text" maxlength="15"  value="<?php echo $rows->machineId;?>" class="form-control styler" required/>
	</div>
	...
	<input id="predictedDeliveryDate" name="predictedDeliveryDate" type="text" maxlength="10"  value="<?php echo $rows->predictedDeliveryDate;?>" class="form-control styler" required/>
	</div>
	...
	<input id="startTheClockDate" name="startTheClockDate" type="text" maxlength="10"  value="<?php echo $rows->startTheClockDate;?>" class="form-control styler" required/>
	</div>
