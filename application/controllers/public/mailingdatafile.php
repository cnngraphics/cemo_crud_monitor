	...
	*/
	...
	include(APP_FOLDER.'/views/public/mailingdatafile/View.php');
	}
	...
	if(get('do')=='export'){
	$result = $this->mailingdatafile_model->SelectAll();
	include(APP_FOLDER.'/views/public/mailingdatafile/Export.php');
	}
	
	//Expeort2
	elseif(get('do')=='export2'){
	$rows = $this->mailingdatafile_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdatafile/Export2.php');
	}
	//SEARCH SUGGEST ////////////////////////////////////////////////////	
	...
	//ADD //////////////////////////////////////////////////
	elseif(get('do')=='add'){
	include(APP_FOLDER.'/views/public/mailingdatafile/Add.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdatafile&do=viewall&msg=add');
	...
	include(APP_FOLDER.'/views/public/mailingdatafile/Update.php');
	}
	...
	json_send(''.H_CLIENT.'&view=mailingdatafile&id='.post('id').'&do=details&msg=update');
	json_success('Process Completed');
	}
	}
	}
	...
	$rows = $this->mailingdatafile_model->SelectOne(get('id'));
	include(APP_FOLDER.'/views/public/mailingdatafile/Details.php');
	}
	
	//TRUNCATE ///////////////////////////////////////////////
	elseif(get('do')=='truncate'){
	$this->mailingdatafile_model->TruncateTable(''.H_CLIENT.'&view=mailingdatafile&do=viewall&msg=truncate');
	include(APP_FOLDER.'/views/public/mailingdatafile/View.php');
	}
	...
	$dfile=get('dfile');
		if(get('id') and $dfile==''){
	$del = $this->mailingdatafile_model->Delete(get('id'),''.H_CLIENT.'&view=mailingdatafile&do=viewall&msg=delete');
	}
	...
	delete_files(UPLOAD_PATH.get('dfile'));
	delete_files(THUMB_PATH.get('dfile'));
	send_to(''.H_CLIENT.'&view=mailingdatafile&id='.get('id').'&do=update&msg=delete');
	}
	}
	}//end invoke
	}//end class
